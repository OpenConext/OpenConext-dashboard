    ...
    return (
      <div className="mod-attributes">
        <table>
          ...
          <tbody>{app.filteredUserAttributes.map(this.renderAttribute.bind(this))}</tbody>
        </table>
        ...
        <ul className="attributes-policy-warnings">
          ...
          <li
            dangerouslySetInnerHTML={{ __html: I18n.t('attributes_policy_panel.nameIdInfo', { type: nameIdValue }) }}
          />
        </ul>
      </div>
    )
