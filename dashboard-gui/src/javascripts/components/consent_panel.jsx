    ...
    return (
      <div className="l-middle-app-detail">
        <div className="mod-title">
          ...
          <p
            className="info"
            dangerouslySetInnerHTML={{ __html: I18n.t(`consent_panel.${subTitle2}`, { name: this.props.app.name }) }}
          ></p>
        </div>
    ...
    return (
      <div className="mod-consent">
        <section className="change-form">
          ...
          {isDashboardAdmin && (
            <a href="/save" className="t-button save" onClick={(e) => this.saveRequest(e)}>
