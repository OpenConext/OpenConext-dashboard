...
class HowToConnectPanel extends React.Component {
  ...
  renderConnectStep(isInvite) {
    const {
      ...
      cancelDialogAction,
      refusedShareContactPersonEmail,
      emailContactPerson,
    } = this.state
    const { app } = this.props
    const { currentUser } = this.context
    ...
    let classNameConnect =
      this.state.accepted && (!app.aansluitovereenkomstRefused || this.state.acceptedAansluitOvereenkomstRefused)
        ? ''
        : 'disabled'
      ...
      <div className="l-middle-app-detail">
        ...
        <div className="mod-connect">
          <div className="box">
            <div className="content">
              ...
              <ul>
                <li>
                  ...
                  <Link to={this.getPanelRoute('license_data')}>{I18n.t('how_to_connect_panel.license_info')}</Link>
                </li>
                <li>
                  {I18n.t('how_to_connect_panel.check')}&nbsp;
                ...
                {hasPrivacyInfo && (
                  <li>
                    {I18n.t('how_to_connect_panel.check')}&nbsp;
                    <Link to={this.getPanelRoute('privacy')}>{I18n.t('how_to_connect_panel.privacy_policy')}</Link>
                  </li>
                )}
                <li>
            ...
            <div className="content">
              ...
              <ul>
                <li>
                  ...
                  <Link to={this.getPanelRoute('attribute_policy')}>{I18n.t('how_to_connect_panel.attributes')}</Link>
                ...
                <li>
                  ...
                  <Link to={this.getPanelRoute('license_data')}>{I18n.t('how_to_connect_panel.license')}</Link>
            ...
            {this.props.app.entityType === 'single_tenant_template' &&
              this.renderSingleTenantServiceWarning(stepNumber++)}
            {connectAutomaticallyWithEmail &&
              this.renderAutomaticConnectionWithEmail(stepNumber++, inValidContactPersonEmail)}
          ...
          <p className="cta">
            {isInvite && (
              <a href="/deny" className="c-button white" onClick={this.denyInvite(this.props.jiraKey)}>
                {I18n.t('how_to_connect_panel.deny')}
              </a>
            )}
            <a
              href="/connection"
              className={'c-button ' + classNameConnect}
              onClick={this.handleMakeConnection(isInvite)}
            >
  ...
  renderLoaLevel = (number) => {
    ...
    const options = [{ value: '', display: I18n.t('consent_panel.defaultLoa') }].concat(
        ...
        <div className="content">
          ...
          <p
            dangerouslySetInnerHTML={{
              __html: I18n.t('overview_panel.single_tenant_service_html', { name: this.props.app.name }),
            }}
          />
    ...
    return (
      <div>
        ...
        <div className="content">
          ...
          <p
            dangerouslySetInnerHTML={{
              __html: I18n.t('overview_panel.aansluitovereenkomstRefused', { name: this.props.app.name }),
            }}
          />
          <label>
            <input
              type="checkbox"
              checked={this.state.acceptedAansluitOvereenkomstRefused}
        ...
        <div className="content">
          ...
          <div className="automatic-connection-with-email">
            <input
              ...
              onChange={(e) => this.setState({ emailContactPerson: e.target.value })}
  ...
  renderDoneDisconnectStep() {
    const subtitle = this.state.action.jiraKey
      ? I18n.t('how_to_connect_panel.done_disconnect_subtitle_html_with_jira_html', {
          jiraKey: this.state.action.jiraKey,
        })
    ...
    return (
      <div className="l-middle-app-detail">
        <div className="mod-title">
          ...
          <br />
          <p className="cta">
            <a href="/apps" onClick={this.backToServices.bind(this)} className="c-button">
              {I18n.t('how_to_connect_panel.back_to_apps')}
            </a>
          </p>
        </div>
      </div>
  ...
  renderDenyInvitation = (jiraKey) => {
    ...
    const app = this.props.app
    return (
      <div className="l-middle-app-detail mod-connect">
        <ConfirmationDialog
          isOpen={confirmationDialogOpen}
          cancel={cancelDialogAction}
          confirm={confirmationDialogAction}
        ...
        <div className="mod-title">
          ...
          />
          <p className="cta">
            <a href="/deny" onClick={this.doDenyInvite(jiraKey)} className="c-button">
              {I18n.t('how_to_connect_panel.deny')}
            </a>
            <a
              href="/accept"
              className="c-button white approve"
              onClick={(e) => {
                stopEvent(e)
                ...
                setTimeout(
                  () =>
                    this.props.history.replace(
                      `/apps/${this.props.app.id}/${this.props.app.entityType}/how_to_connect/${jiraKey}/accept`
                    ),
                  10
                )
              }}
    ...
    <div className="l-middle-app-detail">
      ...
      <div className="mod-connect">
        ...
        <p className="cta">
          <a
            href="/disconnect"
            className={'c-button ' + (this.state.accepted ? '' : 'disabled')}
            onClick={this.handleDisconnect.bind(this)}
          >
  ...
  renderJiraConflict = (action, isConnection) => {
    ...
    const title = isConnection
      ? I18n.t('how_to_connect_panel.connect_title', { app: this.props.app.name })
        ...
        <div className="mod-connect">
          <div className="box">
            <div className="content">
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: I18n.t('how_to_connect_panel.disconnect_jira_info', { jiraKey: action.jiraKey }),
                }}
              />
            </div>
          </div>
  ...
  handleMakeConnection = (isInvite) => (e) => {
    const {
      acceptedAansluitOvereenkomstRefused,
      comments,
      refusedShareContactPersonEmail,
      emailContactPerson,
      loaLevel,
  ...
  render() {
    ...
    switch (currentStep) {
      ...
      case 'connect':
        return conflictingJiraIssue
          ? this.renderJiraConflict(conflictingJiraIssue, true)
          : inviteAction === 'deny'
          ? this.renderDenyInvitation(jiraKey)
          : this.renderConnectStep(jiraKey && inviteAction)
      case 'done':
