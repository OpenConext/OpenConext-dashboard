    ...
    return (
      <div className="form-element">
        <fieldset className={css + ' ' + validClassName}>
          ...
          <p className="label">
            {I18n.t('policy_attributes.attribute')}
            <a
              className="help-link"
              target="_blank"
              rel="noopener noreferrer"
              href={I18n.t('policy_attributes.help_link')}
            >
          ...
          <select value="" onChange={self.handleNewAttribute.bind(this)}>
            ...
            {allowedAttributes.map((allowedAttribute) => {
              return (
                <option value={allowedAttribute.name} key={allowedAttribute.name}>
...
PolicyAttributes.propTypes = {
  ...
  allowedAttributes: PropTypes.arrayOf(
    PropTypes.shape({
