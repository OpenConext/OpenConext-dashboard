  ...
  render() {
    return (
      <div className="form-element about">
        ...
        <p>Uma política de acesso define quando um utilizador tem ou não autorização para aceder a um Serviço com base nos atributos do utilizador fornecidos
        ...
        <p>A Instituição determina a que Instituição esta política se aplica. A Instituição neste contexto é o Fornecedor de Identidade que autenticou o utilizador.
            As políticas podem ser ligadas a nenhuma Instituição ou a várias</p>

        <br/>
        <p>
            Se mantiver o campo Instituição vazio (não selecionar nenhuma Instituição), poderá apenas efetuar Autorização de políticas a Fornecedores de Serviço que pertençam à sua Instituição ligados a este serviço. Se forem selecionadas 1 ou mais Instituições, a sua política de autorização poderá ser aplicada a qualquer fornecedor de Serviço ou a qualquer Instituição que esteja ligada.
        </p>
        ...
        <p>Deve haver uma especial atenção quando se escolhe <em>urn:collab:group:surfteams.nl</em> como um atributo obrigatório.
