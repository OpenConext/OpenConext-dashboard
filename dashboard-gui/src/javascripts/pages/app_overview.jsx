    ...
    let results = [{
      ...
      filterApp: function (app) {
        ...
        if (entityCategoriesFacetSelector && sourceFacetValues.length === 2) {
          return sourceFacetValues.every(sfc => app.entityCategories1 === sfc ||  app.entityCategories2 === sfc ||  app.entityCategories3 === sfc);
        }
        return sourceFacetValues.indexOf(app.entityCategories1) > -1 || sourceFacetValues.indexOf(app.entityCategories2) > -1
