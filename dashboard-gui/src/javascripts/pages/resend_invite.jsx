...
class ResendInvite extends React.Component {
  ...
  sendRequest = e => {
    ...
    resendInviteRequest({idpId: action.idpId, jiraKey: action.jiraKey, comments: message})
      .then(() => {
      ...
      <div>
        ...
        <div className="l-mini mod-resend-invite">
          ...
          <section className="mod-resend-invite-inner">
            <p>{I18n.t("invite_request.resend", {
            ...
            <div className="buttons">
              <a href="/send" className={"t-button save"}
