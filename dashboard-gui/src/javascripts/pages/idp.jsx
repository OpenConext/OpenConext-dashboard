...
class MyIdp extends React.Component {
  ...
  renderServicesFields(institutionServiceProviders, serviceFilters, search) {
    const searchValues = serviceFilters.state.values.reduce(
      (acc, val) => (val.checked ? acc.concat(val.search) : acc),
      []
    )
    let providers =
      searchValues.length > 0
        ? institutionServiceProviders.filter((sp) => searchValues.includes(sp.state))
        : institutionServiceProviders
    if (search.trim().length > 0) {
      const searchString = search.toLowerCase()
      providers = providers.filter(
        (sp) =>
          Object.values(sp.names).some((name) => name.toLowerCase().indexOf(searchString) > -1) ||
        ...
        <table className="services">
          <tbody>
            ...
            <tr>
              ...
              <td>
                {service.guestEnabled ? I18n.t('boolean.yes') : I18n.t('boolean.no')}
                <span>
        ...
        <table className="institution">
          <tbody>
            ...
            <tr>
              ...
              <td>
                {currentIdp.homeUrls.pt}
                <span>
                  <i className="fa fa-info-circle" data-for="organizationURLpt" data-tip></i>
                  <ReactTooltip id="organizationURLpt" type="info" class="tool-tip" effect="solid" multiline={true}>
                    <span dangerouslySetInnerHTML={{ __html: I18n.t('my_idp.organizationURL_pt_tooltip') }} />
                  </ReactTooltip>
                </span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                {currentIdp.organisationNames.en}{' '}
                <span>
            ...
            <tr>
              ...
              <td>
                {currentIdp.organisationNames.nl}{' '}
                <span>
            ...
            <tr>
              ...
              <td>
                {currentIdp.organisationNames.pt}{' '}
                <span>
                  <i className="fa fa-info-circle" data-for="organizationNamePt" data-tip></i>
                  <ReactTooltip id="organizationNamePt" type="info" class="tool-tip" effect="solid" multiline={true}>
                    <span dangerouslySetInnerHTML={{ __html: I18n.t('my_idp.organizationName_pt_tooltip') }} />
                  </ReactTooltip>
                </span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                {currentIdp.organisationDisplayNames.en}{' '}
                <span>
            ...
            <tr>
              ...
              <td>
                {currentIdp.organisationDisplayNames.nl}{' '}
                <span>
            ...
            <tr>
              ...
              <td>
                {currentIdp.organisationDisplayNames.pt}{' '}
                <span>
                  <i className="fa fa-info-circle" data-for="organizationDisplayNamePt" data-tip></i>
                  <ReactTooltip
                    id="organizationDisplayNamePt"
                    type="info"
                    class="tool-tip"
                    effect="solid"
                    multiline={true}
                  >
                    <span dangerouslySetInnerHTML={{ __html: I18n.t('my_idp.organizationDisplayName_pt_tooltip') }} />
                  </ReactTooltip>
                </span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                {currentIdp.connectToRSServicesAutomatically ? I18n.t('boolean.yes') : I18n.t('boolean.no')}
                <span>
            ...
            <tr>
              ...
              <td>
                {currentIdp.allowMaintainersToManageAuthzRules ? I18n.t('boolean.yes') : I18n.t('boolean.no')}
                <span>
            ...
            <tr>
              ...
              <td>
                {currentIdp.displayAdminEmailsInDashboard ? I18n.t('boolean.yes') : I18n.t('boolean.no')}
                <span>
            ...
            <tr>
              ...
              <td>
                {currentIdp.displayStatsInDashboard ? I18n.t('boolean.yes') : I18n.t('boolean.no')}
                <span>
            ...
            <tr>
              ...
              <td>{currentIdp.logoUrl ? <img src={currentIdp.logoUrl} alt={currentIdp.logoUrl} /> : null}</td>
            </tr>
          </tbody>
        </table>
  ...
  renderRoles(roles) {
    return (
      <table>
        ...
        <tbody>{roles.map(this.renderRole.bind(this))}</tbody>
      </table>
    )
  }

  renderRole(role) {
    const names = this.state.roles[role]
      .map((r) => {
      ...
      return (
        <div className="contact-persons">
          ...
          <table>
            ...
            <tbody>{contactPersons.map(this.renderContactPerson.bind(this))}</tbody>
          </table>
        </div>
      )
    }
    ...
    return (
      <div className="l-main">
        ...
        <div className="l-left">
          {hasServices && (
            <ServiceFilter
              onChange={this.onServiceFilterChange.bind(this)}
              filters={{}}
              search={search}
          ...
          <div className="mod-idp">
            ...
            {isDashboardAdmin && (
              <div className="edit-my-idp">
                <Link className="t-button" to={'/my-idp/edit'}>
                  {I18n.t('my_idp.edit')}
                </Link>
              </div>
            )}
            ...
            {!isEmpty(roles) && (
              <h2 className="top">
                {I18n.t('my_idp.roles')}
                <i
                  className={`fa fa-caret-${showRoles ? 'up' : 'down'}`}
                  onClick={() => this.setState({ showRoles: !this.state.showRoles })}
                />
              </h2>
            )}

            {showRoles && !isEmpty(roles) && (
              <div>
