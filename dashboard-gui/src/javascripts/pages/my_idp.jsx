...
function ContactPersons({idp, isDashboardAdmin, currentUser, showModal}) {
    ...
    const contactPersonsFiltered = idp.contactPersons
        .filter(contactPerson => !isEmpty(contactPerson.name) && contactPerson.name !== "null" &&
            !isEmpty(contactPerson.contactPersonType) && contactPerson.contactPersonType.toLowerCase() !== "billing")
    const groupedContactPersons = groupBy(contactPersonsFiltered, (contactPerson) => {
                ...
                <tr>
                    ...
                    <td className="bold">
                        <div className="tooltip-container">
                            ...
                            <Tooltip id="organisation-display-name-en"
                                     text={I18n.t('my_idp.organizationDisplayName_en_tooltip')}/>
                        </div>
                    </td>
                    <td className="bold">
                        <div className="tooltip-container">
                            <div>{idp.organisationDisplayNames.nl}</div>
                            <Tooltip id="organisation-display-name-nl"
                                     text={I18n.t('my_idp.organizationDisplayName_nl_tooltip')}/>
                        </div>
                    </td>
                </tr>
                <tr>
