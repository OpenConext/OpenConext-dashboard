        ...
        <table className="institution">
          <tbody>
            ...
            <tr>
              ...
              <td>{this.renderInput('keywordsPt')}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>{this.renderInput('descriptionsPt')}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>{this.renderInput('displayNamesPt')}</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                {I18n.t('my_idp.organizationURL.pt')}
                <span>
              ...
              <td>{this.renderInput('organisationUrlPt')}</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                {I18n.t('my_idp.organizationName.pt')}
                <span>
              ...
              <td>{this.renderInput('organisationNamePt')}</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                {I18n.t('my_idp.organizationDisplayName.pt')}
                <span>
              ...
              <td>{this.renderInput('organisationDisplayNamePt')}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>{this.renderInput('logoUrl')}</td>
            </tr>
            <tr>
  ...
  renderServicesFields(serviceFilters, serviceProviderSettings, search) {
    ...
    let providers =
      searchValues.length > 0
        ? serviceProviderSettings.filter((sp) => searchValues.includes(sp.state))
        : serviceProviderSettings
