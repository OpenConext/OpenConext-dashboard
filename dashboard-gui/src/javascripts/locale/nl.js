...
I18n.translations.nl = {
  ...
  attributes_policy_panel: {
    arp: {
      ...
      manipulation:
        "Voor deze Service Provider is er een aangepast 'attribuut manipulatie script' actief. SURFconext voert het script uit bij elke authenticatie van een gebruiker, voordat attributen aan die service worden vrijgegeven. Om je te helpen begrijpen welke informatie zal worden vrijgegeven, vind je hieronder een beschrijving van wat het script doet:",
      resourceServers:
