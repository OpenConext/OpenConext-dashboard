...
I18n.translations.nl = {
    ...
    attributes_policy_panel: {
        ...
        attributes: {
            ...
            "urn:oasis:names:tc:SAML:2.0:nameid-format:persistent": "Unieke ID",
            "urn:mace:dir:attribute-def:eduPersonPrincipalName": "Unieke IdP identifier",
            "urn:mace:dir:attribute-def:displayName": "Weergave name",
            "urn:mace:dir:attribute-def:cn": "Achternaam",
            ...
            "urn:mace:terena.org:attribute-def:schacHomeOrganizationType": "Typevanf IdP",
            "urn:schac:attribute-def:schacPersonalUniqueCode": "Unieke code IdP",
            ...
            "urn:mace:surf.nl:attribute-def:eckid": "edu-L URL",
            "urn:mace:eduid.nl:1.1": "ediUD identifier",
    ...
    mfa_panel: {
        title: 'MFA',
        subtitle:
            'Met <a href="https://wiki.surfnet.nl/display/surfconextdev/MFA+voor+diensten+achter+SURFconext" target="_blank" rel="noopener noreferrer">MFA</a> kan een mutl-factor authenticatie worden afgedwongen door je eigen IdP voor deze dienst.',
        subtitle2:
