...
<head>
  ...
  <link rel="stylesheet" href="<c:url value="/css/coin-selfservice.css"/>"/>
  <!--[if lt IE 9]>
...
<div class="wrapper">
           ...
           <section>
               ...
               <div class="content">
                   ...
                   <a href="form.html" class="btn btn-primary" data-form="true" data-confirm="Are you sure?">Post request with a confirm</a>
                   <a href="form.html" class="btn btn-primary" data-form="true" data-success="The post request was successfull">Post request with a succes message</a>
                   <a href="form.html" data-form="true" data-confirm="Just press ok and see the message!" data-success="Yes we did it again!!">Post with confirm and success message</a>
               </div>
           ...
           <section>
               ...
               <div class="content">
                   ...
                   <p>This <a rel="tooltip" data-type="info" href="#" data-original-title="Tooltip message">tooltip</a> is in a sentence.</p>

                   <h3>Popover (default)</h3>

                   <a rel="popover" class="badge badge-success" href="#" data-original-title="Content title" data-content="And here's some amazing content. It's very engaging. right?">?</a>

                   <h3>Popover (success/green)</h3>

                   <a rel="popover" data-type="success" class="badge badge-success" href="#" data-content="And here's some amazing content. It's very engaging. right?">?</a>

                   <h3>Popover (info/blue)</h3>

                   <a rel="popover" data-type="info" class="badge badge-info" href="#" data-content="And here's some amazing content. It's very engaging. right?">?</a>
                   ...
                   <table class="table table-bordered table-striped table-above-pagination">
                       ...
                       <tbody>
                           <tr>
                               ...
                               <td class="center">
                                   <a href="#" rel="tooltip" data-type="info" title="Edit object"><i class="icon-pencil"></i></a><a href="http://example.org/api/user/?id=5&amp;action=delete" data-type="info" rel="tooltip" title="Delete object" data-form="true" data-confirm="Are you sure?"><i class="icon-remove"></i></a>
                               </td>
                           </tr>
                           <tr>
                               <td>UT12</td>
                               ...
                               <td class="center">
                                   ...
                                   <a href="http://example.org/api/user/?id=5&amp;action=delete" rel="tooltip" title="Delete object" data-type="info" data-form="true"><i class="icon-remove"></i></a>
                               </td>
                           </tr>
                           <tr>
                               <td>UT12</td>
                               ...
                               <td class="center">
                                   ...
                                   <a href="?id=5&amp;action=delete" rel="tooltip" title="Delete object" data-form="true" data-type="info" data-confirm="Are you sure?"><i class="icon-remove"></i></a>
                               </td>
                           </tr>
                       </tbody>
                   </table>
               ...
               <div class="content">
                   ...
                   <div class="modal modal-relative">
                       ...
                       <div class="modal-body">
                           ...
                           <p>You do not have access to virtual resources for Bandwith on Demand yet. You have to select a Collaboration team with whome you want to share Bandwith on Demand and ask an ICT manager of an organisation, which offers BoD, for virtual resources.</p>
                       </div>
                       <div class="actions">
...
<script src="<c:url value="/js/coin-selfservice.js"/>"></script>
</body>
</html>