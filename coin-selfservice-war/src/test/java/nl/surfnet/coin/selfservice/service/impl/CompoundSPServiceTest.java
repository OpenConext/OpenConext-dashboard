...
public class CompoundSPServiceTest {
  ...
  /**
   *
   * Get a list of all CSPs for a given IDP.
   * This test checks that for SPs in the ServiceProviderService
   * that have no corresponding CSP yet, one will be created.
   */
  @Test
